                        ...
                        <div class="job_details_header">
                            <div class="single_jobs white-bg d-flex justify-content-between">
                                <div class="jobs_left d-flex align-items-center">
                                    ...
                                    <div class="jobs_conetent">
                                        ...
                                        <div class="links_locat d-flex align-items-center">
                                            ...
                                            <div class="location">
                                                <p> <i class="fa fa-clock-o"></i> Job Created By {{ $job->user->name }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="jobs_right">
                                    <div class="apply_now">
                                        <a class="heart_mark {{ ($count == 1) ? 'saved-job' : '' }}" onclick="saveJob({{ $job->id }})" href="javascript:void(0);"> <i class="fa fa-heart-o" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
